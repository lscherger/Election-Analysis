...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the candidate does not match any existing candidates, add to candidate list.
...
with open(file_to_save, "w") as txt_file:
    ...
    # Print the winning candidate's results summary to the terminal. 
    ...
    # Save the winning candidate's resutls to the text file. 
